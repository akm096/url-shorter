    ...
    if (!\App\verify_csrf($token)) {
        ...
        if (!\App\validate_url($target_url)) {
            ...
            if ($custom_slug === '') {
                ...
                if (db\get_link_by_slug($custom_slug) !== null) {
...
<head>
    ...
    <style>
        ...
        .wrap {max-width: 720px; margin: 0 auto; background: #fff; border:1px solid #ddd; border-radius: 8px; padding: 22px;}
        ...
        button {margin-top: 16px; padding: 10px 14px; border:1px solid #333; background:#333; color:#fff; border-radius: 6px; cursor:pointer;}
        button:hover {opacity: .9;}
        .top {display:flex; justify-content: space-between; align-items:center; gap: 12px; flex-wrap: wrap;}
        .top a {text-decoration:none; color:#0b57d0;}
        .msg {margin-top: 14px; padding: 12px; border-radius: 6px;}
        .err {background:#ffecec; border:1px solid #f5a3a3; color:#a40000;}
        .ok {background:#ecfff1; border:1px solid #9fe0b2; color:#0a5a22;}
        .short-box {margin-top: 10px; display:flex; gap:10px; align-items:center; flex-wrap: wrap;}
        .short-box input {flex: 1 1 320px;}
...
<body>
    <div class="wrap">
        ...
        <form method="post" action="">
            ...
            <input type="text" name="target_url" id="target_url" required placeholder="https://ornek.com/uzun-link" value="<?php echo \App\e($target_url); ?>">
